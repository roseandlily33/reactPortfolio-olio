  ...
  return (
    <CertificateContainer>
      <TopContainer>
        ...
        <p>Portfolio project for a fake company that sells juice.</p>
        <p>
          The project specified to use Dall-E & Chat-GPT to create these
          different assets
        </p>
      </TopContainer>
      ...
      <EachCaseStudyContainer>
        <div>
          <h3>Overview</h3>
          <p>Berry & Bloom is a whimsical, flower-powered juice company based in Sacramento, California. Founded by longtime florists Lil & Phill, the brand blossoms from their beloved flower shop into a vibrant juice venture inspired by nature’s most beautiful gifts—blooms and botanicals.

Berry & Bloom blends florals and fruits into refreshing, health-conscious juices, all crafted with care and creativity. The brand embraces a whimsical, botanical aesthetic, using a soft palette of purple, pink, yellow, and green with swirly script fonts, delicate illustrations, and a warm, handcrafted tone.</p>
          ...
          <p>
            ...
            fruits into a joyful, health-forward juice experience. “From petal
            to press made with love.”
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <h4>Tone & Style</h4>
          <p>Whimsical, heartfelt, nature-rooted. Earthy but not preachy. Think wildflower fields, gentle humor, and poetic captions.</p>
          <h4>Channels & Frequency</h4>
          <p>Instagram <span> 4-5x per week</span></p>
          <p>Tiktok <span>3x per week</span></p>
          <p>Pinterest <span>2x per week</span></p>
          <p>Email Newsletter <span>2x per month</span></p>
          <p>Youtube Shorts/Reels <span>1-2x per week</span></p>
        ...
        <div>
          ...
          <span>
            My idea way to have them each in a different color representing each
