...
export const projectListFrontEnd = [
  {
    ...
    status: true,
    description:
      "A front end quiz application to test your knowledge on Javascript. Built with HTML, CSS and JS.",
    img: Quiz,
    type: "Front End",
    important: true,
  ...
  },
  {
    ...
    status: true,
    description:
      "A Front End weather application that uses openWeatherAPI. Built with HTML, CSS, and JS.",
    img: Weather,
    type: "Front End",
    important: true,
  ...
  //Up on render and is working - project is not finished
  {
    ...
    description:
      "React Application. Uses Spotify API to create your own spotify playlist that has all your favourite songs. Currently still under development.",
    img: Jammin,
    type: "Front End",
    important: true,
  ...
  },
  {
    ...
    description:
      "Small Picture in Picture application built with HTML, CSS & JS",
