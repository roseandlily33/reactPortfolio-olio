...
const CampaignBB = () => {
  return (
    <>
      {/* <CaseStudySection> */}
      <SectionHeader>Market Campaign Strategy</SectionHeader>
      <SubHeader>Campaign Title</SubHeader>
      <SectionText>“Drink What You Bloom”</SectionText>
      <SubHeader>
        Campaign Goals
      </SubHeader>
      <SectionText>
        <strong>Awareness:</strong> Introduce Berry & Bloom as a juice brand to
        both local and online audiences.
        <br />
